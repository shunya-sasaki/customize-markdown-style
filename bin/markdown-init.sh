...
# This script is used to initialize the work directory for the Markdown project.
...
vscode_dirpath="${script_dirpath}/../.vscode"
...
# copy the vscode settings to the work directory
if [ ! -e "${target_dirpath}/.vscode" ]; then
    echo "copying vscode settings to work directory"
    cp -r ${vscode_dirpath} $target_dirpath/.vscode
fi
